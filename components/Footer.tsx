      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-neutral-400 text-sm leading-relaxed max-w-xs">
              Launch once, grow everywhere. The complete headless commerce platform for modern businesses.
            </p>
        ...
        <div className="border-t border-neutral-800 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-neutral-400 text-sm">
            © {new Date().getFullYear()} HeadlessPro. All rights reserved.
          </p>
          <div className="mt-4 sm:mt-0 flex space-x-6 text-sm">
            <a href="/legal/terms" className="text-neutral-400 hover:text-white transition-colors duration-200">
              Terms
            </a>
            <a href="/legal/privacy" className="text-neutral-400 hover:text-white transition-colors duration-200">
              Privacy
            </a>
            <a href="/legal/cookies" className="text-neutral-400 hover:text-white transition-colors duration-200">
              Cookies
            </a>
          </div>
        </div>
